//  keccak_round.sv
//  Markku-Juhani O. Saarinen <mjos@iki.fi>.  BSD 3-Clause License.
//  Imported into Marian from sloth/rtl/keccak_round.v (SLOTH_KECCAK guard removed).
...
module keccak_round(
    ...
    //  Step 2
    wire [319:0]    d_w;
    assign d_w = {   c_w[255:  0], c_w[319:256] } ^
                 {   c_w[ 62:  0], c_w[ 63],
                     c_w[318:256], c_w[319],
                     c_w[254:192], c_w[255],
                     c_w[190:128], c_w[191],
    ...
    //  Step 3
    wire [1599:0]   th_w;
    assign th_w = s_i ^ { d_w, d_w, d_w, d_w, d_w };

    //  Rho (3.2.2), Pi (3.2.3), Combined Algorithms 2 and 3

    wire [1599:0]   rp_w;
    assign rp_w = {   th_w[1405:1344], th_w[1407:1406],
