...
module sbox_inv_mid( output wire [17:0] y, input wire [20:0] x );
...
module sbox_aes_top( output wire [20:0] y, input wire [7:0] x);
...
module sbox_aes_out( output wire [7:0] y, input wire [17:0] x);
...
module aes_sbox( output wire [7:0] fx, input wire [7:0] in );
...
module sbox_aesi_top( output wire [20:0] y, input wire [7:0] x);
...
module sbox_aesi_out( output wire [7:0] y, input wire [17:0] x);
...
module aesi_sbox( output wire [7:0] fx, input wire [7:0] in );
...
module sbox_sm4_top( output wire [20:0] y, input wire [7:0] x);
...
module sbox_sm4_out( output wire [7:0] y, input wire [17:0] x);
...
module sm4_sbox( output wire [7:0] fx, input wire [7:0] in );
