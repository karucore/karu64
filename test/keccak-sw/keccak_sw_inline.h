// Pinned portable Keccak-f[1600] from karudeb/tools/pqc/mlkem/keccak.c.
// Original file SHA256: 3dd74d379a3cb9cfe02a30d128e0baf35af070ef6da84ed5c8898f605a5983cd
// VK_KECCAK=0 branch, instrumentation removed, function made always_inline.
// Kept locally so reproduction does not depend on a companion checkout.
#define NROUNDS 24
#define ROL(a, offset) ((a << offset) ^ (a >> (64 - offset)))
// karudeb portable permutation; only always_inline and counter removal differ.
...
static inline __attribute__((always_inline)) void KeccakF1600_StatePermute(uint64_t state[25])
{
    int round;
