# VCU118 DDR4 C1 explicit PACKAGE_PIN constraints for the experimental
# custom-mode DDR4-2133 MIG. Enable only with KARU_DDR4_CUSTOM_2133; no default
# configuration reads this file.
#
# Source: flow/fpga/ddr4_custom/ddr4_board_pins.txt, extracted from the routed
# board-preset ddr4_sdram_c1 design. The DDR4 IP-generated XDC still owns the
# clock, IOSTANDARD, output-impedance, timing, and PHY constraints; this file
# only replaces the board preset's BOARD_PART_PIN mapping with concrete LOCs.
