...
reg           maccore_crg_reset_wr_stb = 1'd0;
...
reg           maccore_reset_wr_stb = 1'd0;
reg    [31:0] maccore_scratch_storage = 32'd305419896;
reg           maccore_scratch_wr_stb = 1'd0;
...
always @(*) begin
    slave_sel <= 3'd0;
    slave_sel[0] <= (shared_adr[29:10] == 17'd69648);
    slave_sel[1] <= (shared_adr[29:10] == 17'd69649);
    slave_sel[2] <= (shared_adr[29:14] == 13'd4352);
end
...
assign maccore_bus_errors_rd_stb = csrbank0_bus_errors_we;
...
assign maccore__r_rd_stb = csrbank2_mdio_r_we;
...
always @(posedge sys_clk) begin
    ...
    maccore_reset_wr_stb <= csrbank0_reset0_re;
    if (csrbank0_scratch0_re) begin
        maccore_scratch_storage <= csrbank0_scratch0_r;
    end
    maccore_scratch_wr_stb <= csrbank0_scratch0_re;
    maccore_bus_errors_wr_stb <= csrbank0_bus_errors_re;
    ...
    maccore_crg_reset_wr_stb <= csrbank2_crg_reset0_re;
    if (csrbank2_mdio_w0_re) begin
        maccore__w_storage <= csrbank2_mdio_w0_r;
    end
    maccore__w_wr_stb <= csrbank2_mdio_w0_re;
    maccore__r_wr_stb <= csrbank2_mdio_r_re;
    if (sys_rst) begin
        maccore_reset_storage <= 2'd0;
        maccore_reset_wr_stb <= 1'd0;
        maccore_scratch_storage <= 32'd305419896;
        maccore_scratch_wr_stb <= 1'd0;
        maccore_bus_errors_wr_stb <= 1'd0;
        maccore_bus_errors <= 32'd0;
        maccore_crg_reset_storage <= 1'd0;
        maccore_crg_reset_wr_stb <= 1'd0;
        maccore_crg_counter <= 9'd0;
        maccore__w_storage <= 3'd0;
        maccore__w_wr_stb <= 1'd0;
        maccore__r_wr_stb <= 1'd0;
        core_wr_stb <= 1'd0;
...
// The DDR hardware timing-probe build currently uses an internal MII loopback
// and exposes no board MDIO pin. Keep the MDIO read side idle instead of
// instantiating an unplaceable internal IO primitive.
assign maccore_data_r = 1'b1;
`else
//------------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2026-06-04 15:57:37.
//------------------------------------------------------------------------------
